...
*/
-- AlterTable
ALTER TABLE `admin` MODIFY `image` VARCHAR(255) NULL,
    MODIFY `tanggal_lahir` DATETIME NOT NULL;

-- AlterTable
ALTER TABLE `diskusi` MODIFY `tanggal_post` DATETIME NOT NULL;

-- AlterTable
ALTER TABLE `guru` MODIFY `image` VARCHAR(255) NULL,
    MODIFY `tanggal_lahir` DATETIME NOT NULL;
...
-- AlterTable
ALTER TABLE `siswa` MODIFY `image` VARCHAR(255) NULL,
    MODIFY `tanggal_lahir` DATETIME NOT NULL;
