/*
  ...
  - The values [aktif,nonaktif] on the enum `jadwal_status` will be removed. If these variants are still used in the database, this will fail.
...
-- AlterTable
ALTER TABLE `jadwal` MODIFY `status` ENUM('Aktif', 'Nonaktif') NOT NULL;
